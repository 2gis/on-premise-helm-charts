...
keys
	...
	+ keys-backend:1.180.1
	- keys-ui:1.7.9
	+ keys-ui:1.9.1
```
[Full list of image versions](https://github.com/2gis/on-premise-helm-charts/blob/Core-2.11.1/changelogs/core/core_image_versions.txt)
...
keys
	...
	+ keys-ui:1.7.9
```
[Full list of image versions](https://github.com/2gis/on-premise-helm-charts/blob/Core-2.11.0/changelogs/core/core_image_versions.txt)
