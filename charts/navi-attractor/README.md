# 2GIS Navi-Attractor service

This Helm chart deploys the **Navi-Attractor service**, a component of the 2GIS [On-Premise](https://docs.2gis.com/en/on-premise-api-platform/overview/summary#navigation).
...
| `attractor.sentry.environment`            | Environment name                                                                                                                                                       | `""`                                        |
| `attractor.sentry.reportPath`             | Local directory to dump                                                                                                                                                | `/tmp/sentry`                               |
| `attractor.sentry.handler`                | Handler file location                                                                                                                                                  | `/usr/sbin/2gis/navi-back/crashpad_handler` |
| `attractor.sentry.minSeverityLevel`       | Minimal severity level to log in sentry                                                                                                                                | `error`                                     |
| `attractor.sentry.logsBufferSize`         | Size of buffer to send to sentry                                                                                                                                       | `100`                                       |
| `attractor.telemetry.enabled`             | Send telemetry to Opentelemetry server                                                                                                                                 | `false`                                     |
| `attractor.telemetry.host`                | Telemetry host                                                                                                                                                         | `telemetry.server`                          |
| `attractor.telemetry.port`                | Telemetry port                                                                                                                                                         | `4318`                                      |
| `attractor.telemetry.maxQueueSize`        | Max number of buffered spans                                                                                                                                           | `2048`                                      |
