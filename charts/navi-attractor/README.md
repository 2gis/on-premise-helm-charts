...
| Name               | Description | Value                        |
| ------------------ | ----------- | ---------------------------- |
| `image.repository` | Repository  | `2gis-on-premise/attractord` |
...
| `attractor.mock`                  | If mock service being deployed. For test purposes only.             | `false`           |
...
| `frozenData.image.repository`          | Repository                                  | `navi/frozen-data`          |
| `frozenData.image.tag`                 | Tag                                         | `perftesting-common-master` |
