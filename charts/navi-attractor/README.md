...
| `command`                            | Override default command                                                                                                    | `["/usr/sbin/2gis/mosesd/tini","--"]`                                                                                                                                                                                          |
| `args`                               | Override default args                                                                                                       | `["/usr/sbin/2gis/mosesd/attractord","--config","{{ .Values.attractor.configFilepath }}/attractord.conf","--validate-config","/usr/share/2gis/schemas/config_schemas/attractor_conf.schema.json","--validate-config-dry-run"]` |
