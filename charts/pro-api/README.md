...
| `api.pod.resources.limits.memory`                           | A memory limit.                                                                                                                                                                                                                                        | `1024Mi`                  |
...
| `permissions.image.tag`                          | Tag                                                                                                                                              | `2.51.0`                              |
...
| `permissions.pod.resources.requests.memory`      | A memory request.                                                                                                                                | `256Mi`                               |
| `permissions.pod.resources.limits.cpu`           | A CPU limit.                                                                                                                                     | `1`                                   |
| `permissions.pod.resources.limits.memory`        | A memory limit.                                                                                                                                  | `1024Mi`                              |
...
| `permissions.settings.default_permissions.add_user_assets.file_size` | Maximum file size of the asset that can be added by the user.                                                                       | `100`                   |
...
| `tasks.pod.resources.limits.memory`                        | A memory limit.                                                                                                                                                                                          | `1024Mi`                        |
...
| `tasks.vpa.minAllowed.memory`                              | Lower limit for the RAM size to which the autoscaler can scale down.                                                                                                                                     | `256Mi`                         |
| `tasks.vpa.maxAllowed.cpu`                                 | Upper limit for the number of CPUs to which the autoscaler can scale up.                                                                                                                                 | `1`                             |
| `tasks.vpa.maxAllowed.memory`                              | Upper limit for the RAM size to which the autoscaler can scale up.                                                                                                                                       | `1024Mi`                        |
...
| `tasks.pdb.enabled`                                        | If PDB is enabled for the service.                                                                                                                                                                       | `false`                         |
| `tasks.pdb.minAvailable`                                   | How many pods must be available after the eviction.                                                                                                                                                      | `1`                             |
| `tasks.pdb.maxUnavailable`                                 | How many pods can be unavailable after the eviction.                                                                                                                                                     | `""`                            |
...
| `tasks.settings.auth.enabled`                              | Enables or disables authentication **Required**                                                                                                                                                          | `false`                         |
| `tasks.settings.auth.apiKey`                               | Api key for service to service calls **Required**                                                                                                                                                        | `""`                            |
| `tasks.settings.auth.adminRequiredRoles`                   | Roles required to access Tasks Admin UI. Example: `Admin`                                                                                                                                                | `[]`                            |

### Page Renderer API configuration & settings

| Name                                             | Description                                                                                                                                      | Value                                  |
| ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------- |
| `pagerenderer.image.repository`                  | Repository                                                                                                                                       | `2gis-on-premise/pro-pagerenderer-api` |
| `pagerenderer.image.tag`                         | Tag                                                                                                                                              | `2.51.0`                               |
...
| `pagerenderer.pod.annotations`                   | Kubernetes [annotations](https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations/).                                        | `{}`                                   |
| `pagerenderer.pod.labels`                        | Kubernetes [labels](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/).                                                  | `{}`                                   |
| `pagerenderer.pod.revisionHistoryLimit`          | Revision history limit (used for [rolling back](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/) a deployment).   | `3`                                    |
| `pagerenderer.pod.resources`                     | **Limits for the application service**                                                                                                           |                                        |
| `pagerenderer.pod.resources.requests.cpu`        | A CPU request.                                                                                                                                   | `300m`                                 |
| `pagerenderer.pod.resources.requests.memory`     | A memory request.                                                                                                                                | `256Mi`                                |
| `pagerenderer.pod.resources.limits.cpu`          | A CPU limit.                                                                                                                                     | `1`                                    |
| `pagerenderer.pod.resources.limits.memory`       | A memory limit.                                                                                                                                  | `1024Mi`                               |
| `pagerenderer.service.annotations`               | Kubernetes [service annotations](https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations/)                                 | `{}`                                   |
| `pagerenderer.service.labels`                    | Kubernetes [service labels](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/).                                          | `{}`                                   |
| `pagerenderer.service.type`                      | Kubernetes [service type](https://kubernetes.io/docs/concepts/services-networking/service/#publishing-services-service-types).                   | `ClusterIP`                            |
| `pagerenderer.service.port`                      | PRO API service port.                                                                                                                            | `80`                                   |
...
| `pagerenderer.settings.auth.apiKey`     | Secret API Key to perform authorized service actions, random string. Example: `4230b288-301e-4ec6-82c6-db6a8a72c2af`                                    | `""`     |
...
| `assetImporter.tag`                                | Docker image tag.                                                                                                                                        | `2.51.0`                       |
...
| `assetImporter.resources.requests.memory`          | A memory request.                                                                                                                                        | `768Mi`                        |
| `assetImporter.resources.limits.cpu`               | A CPU limit.                                                                                                                                             | `1000m`                        |
| `assetImporter.resources.limits.memory`            | A memory limit.                                                                                                                                          | `8192Mi`                       |
...
| Name                                   | Description                                                                  | Value   |
| -------------------------------------- | ---------------------------------------------------------------------------- | ------- |
| `authProvider.enabled`                 | Enables or disables the AuthProvider **Required**                            | `false` |
| `authProvider.host`                    | Host address of the authentication provider (used if enabled is true)        | `""`    |
| `authProvider.schema`                  | Authentication scheme to use. Supported values: "Basic", "Oidc" **Required** | `""`    |
...
| `authProvider.oidc.nameClaim`          | Claim name that contains the user's name. Example: 'name'                    | `""`    |
| `authProvider.oidc.roleClaim`          | Claim name that contains the user's role. Example: 'role'                    | `""`    |
...
| `kafka.securityProtocol`               | Kafka security protocol. Supported options: Plaintext, SaslPlaintext.                                                             | `SaslPlaintext` |
...
| `kafka.sasl.mechanism`                 | Kafka sasl mechanism. Supported options: Plain, ScramSha256, ScramSha512.                                                         | `ScramSha512`   |
