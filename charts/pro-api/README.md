...
| `permissions.image.tag`                          | Tag                                                                                                                                                              | `1.45.0`                              |
...
| Name                                                       | Description                                                                                                                                                                                              | Value                                |
| ---------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ |
| `tasks.image.repository`                                   | Repository                                                                                                                                                                                               | `2gis-on-premise/urbi-geo-tasks-api` |
| `tasks.image.tag`                                          | Tag                                                                                                                                                                                                      | `1.45.0`                             |
...
| `tasks.ingress.hosts[0].host`                              | Hostname for the Ingress service                                                                                                                                                                         | `""`                                 |
...
| `tasks.pod.apiReplicaCount`                                | A replica count for the pod.                                                                                                                                                                             | `2`                                  |
| `tasks.pod.workerReplicaCount`                             | A replica count for the pod.                                                                                                                                                                             | `2`                                  |
...
| `tasks.settings.enabled`                                   | If Tasks API is disabled it will not be deployed to k8s                                                                                                                                                  | `false`                              |
...
| `assetImporter.tag`                                | Docker image tag.                                                                                                                                        | `1.45.0`                       |
