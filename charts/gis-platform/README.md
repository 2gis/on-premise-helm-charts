...
| ------------------- | ----------------------------------- | -------------- |
| `external_hostname` | Service hostname.                   | `gis-platform` |
...
| `ingress.hosts`       | List of hosts. Must be a list, where each item has `host` property. <br/> Defaults to `[{'host': 'gis-platform.local'}]`. |         |
...
| `spcore.s3.host`                            | S3 endpoint. Format: `host:port`.                                                         | `s3.example.com`               |
...
| `spcore.pg.host`                            | PostgreSQL host.                                                                          | `localhost`                    |
...
| `spcore.catalog.url`                        | Catalog service URL.                                                                      | `https://catalog.api.2gis.com` |
| `spcore.catalog.key`                        | Catalog access key.                                                                       | `""`                           |
| `spcore.navi`                               | **Navi settings.**                                                                        |                                |
| `spcore.navi.url`                           | Navi service URL.                                                                         | `https://catalog.api.2gis.com` |
