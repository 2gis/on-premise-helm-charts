...
| `image.tag`        | Backend service image tag.                                                                    | `1.6.0`                     |
...
| `api.auth.access`                           | **API Keys service access settings**                                                                                                                                                                     |                 |
| `api.auth.endpoint`                         | API Keys endpoint url, ex: http://keys-api.svc. **Required**                                                                                                                                             | `""`            |
| `api.auth.serviceKey`                       | Service key for Keys API. **Required**                                                                                                                                                                   | `""`            |
| `api.auth.clientTimeout`                    | Timeout for Keys API requests.                                                                                                                                                                           | `5s`            |
