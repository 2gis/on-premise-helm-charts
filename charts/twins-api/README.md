...
This Helm chart deploys the **API Twins service**, a component of the 2GIS [On-Premise](https://docs.2gis.com/en/on-premise-api-platform/overview/summary).
...
| `api.keys.url`                              | URL of the Keys API service, ex: http://keys-service-api.svc. This URL should be accessible from all the pods within your Kubernetes cluster. **Required**                                               | `""`            |
