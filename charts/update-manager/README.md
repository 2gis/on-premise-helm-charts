...
| `api.strategy.rollingUpdate.maxUnavailable` | Maximum number of pods that can be unavailable during the [rolling update](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/#rolling-update-deployment) process.                     | `0`                                |
| `api.strategy.rollingUpdate.maxSurge`       | Maximum number of pods that can be created over the desired number of pods when doing [rolling update](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/#rolling-update-deployment). | `1`                                |
...
| `dgctlStorage.secure`    | Set to `true` if dgctlStorage.host must be accessed via https. | `false` |
...
| Name                                                                       | Description                                                                                                                                                | Value                                                                               |
| -------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `api.components.core`                                                      | Services helm releases of the [`core` component](https://docs.2gis.com/en/on-premise-api-platform/core/releases).                                          |                                                                                     |
| `api.components.core.version`                                              | Version of the `core` component services releases.                                                                                                         | `2.9.0`                                                                             |
| `api.components.core.charts.keys`                                          | Settings for the `keys` chart of the [API Keys service](https://docs.2gis.com/en/on-premise-api-platform/core/install/keys).                               |                                                                                     |
...
| `api.components.api-platform`                                              | Services helm releases of the [`api-platform` component](https://docs.2gis.com/en/on-premise-api-platform/api-platform/releases).                          |                                                                                     |
| `api.components.api-platform.version`                                      | Version of the `api-platform` component services releases.                                                                                                 | `2.56.0`                                                                            |
| `api.components.api-platform.charts.tiles-api`                             | Settings for the `tiles-api` chart of the [Maps API](https://docs.2gis.com/en/on-premise-api-platform/api-platform/install/maps).                          |                                                                                     |
...
| `api.components.api-platform.charts.search-api`                            | Settings for the `search-api` chart of the [Search API (search)](https://docs.2gis.com/en/on-premise-api-platform/api-platform/install/search).            |                                                                                     |
...
| `api.components.api-platform.charts.catalog-api`                           | Settings for the `catalog-api` chart of the [Search API (catalog)](https://docs.2gis.com/en/on-premise-api-platform/api-platform/install/search).          |                                                                                     |
...
| `api.components.api-platform.charts.search-api-v8`                         | Settings for the `search-api-v8` chart of the [Search API (new version)](https://docs.2gis.com/en/on-premise-api-platform/api-platform/install/search-v8). |                                                                                     |
...
| `api.components.api-platform.charts.navi-castle`                           | Settings for the `navi-castle` chart of the [Navigation API](https://docs.2gis.com/en/on-premise-api-platform/api-platform/install/navigation).            |                                                                                     |
...
| `api.components.api-platform.charts.twins-api`                             | Settings for the `twins-api` chart.                                                                                                                        |                                                                                     |
...
| `api.components.pro`                                                       | Services helm releases of the [`pro` component](https://docs.2gis.com/en/on-premise-pro/releases).                                                         |                                                                                     |
| `api.components.pro.version`                                               | Version of the `pro` component services releases.                                                                                                          | `2.5.0`                                                                             |
| `api.components.pro.charts.pro-ui`                                         | Settings for the `pro-ui` chart of the [2GIS Pro (ui)](https://docs.2gis.com/en/on-premise-pro/install/installation).                                      |                                                                                     |
...
| `api.components.pro.charts.pro-api`                                        | Settings for the `pro-api` chart of the [2GIS Pro (api)](https://docs.2gis.com/en/on-premise-pro/install/installation).                                    |                                                                                     |
...
| `api.components.pro.charts.pro-api.releases[0].services`                   | List of DGCTL services attached to the release. Allowed values: "pro-api".                                                                                 | `["pro-api"]`                                                                       |
| `api.components.citylens`                                                  | Services helm releases of the [`citylens` component](https://docs.2gis.com/en/on-premise-citylens/releases).                                               |                                                                                     |
| `api.components.citylens.version`                                          | Version of the `citylens` component services releases.                                                                                                     | `2.3.0`                                                                             |
| `api.components.citylens.charts.citylens`                                  | Settings for the `citylens` chart of the [CityLens](https://docs.2gis.com/en/on-premise-citylens/install/installation).                                    |                                                                                     |
