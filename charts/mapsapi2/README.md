...
| `api.tileServer`             | URL of the tile server, e.g. 'https://tiles-api.ingress.host/tiles?x={x}&y={y}&z={z}'.     | `""`     |
| `api.retinaTileServer`       | URL of the retina tile server.                                                             | `""`     |
| `api.trafficTileServer`      | URL of the traffic tiles server.                                                           | `""`     |
| `api.trafficTimestampServer` | URL of the traffic timestamps server.                                                      | `""`     |
| `api.trafficScoreServer`     | URL of the traffic scores server.                                                          | `""`     |
| `api.webApiServer`           | URL of the Catalog API service, e.g. 'https://catalog-api.ingress.host'.                   | `""`     |
