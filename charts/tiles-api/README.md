...
| `warningText`  | Warning message on raster tiles for 'soft' block. Should contain '%d' for the number of days until the 'hard' block and '%s' for the sales manager contact information.                                                                                                                 | `License expiring in %d days.\nPlease contact your sales manager.\n%s` |
| `errorText`    | Error message on raster tiles for 'hard' block. Should contain '%s' for the sales manager contact information.                                                                                                                                                                          | `License expired.\nPlease contact your sales manager.\n%s`             |
| `salesManager` | Sales manager contact information that will be used in warning and error messages on raster tiles for all kinds of blocks.                                                                                                                                                              | `on-premise@2gis.com`                                                  |
...
| `proxy.image.tag`                 | Docker image tag.                                                                                                             | `4.31.0`                          |
...
| `api.image.tag`                             | Docker image tag.                                                                                                                                                                                        | `4.31.0`                    |
...
| `importer.image.tag`                         | Docker image tag.                                                                                                                                                                                                                                                                                                                    | `4.31.0`                             |
...
| Name                  | Description                                                                                     | Value |
| --------------------- | ----------------------------------------------------------------------------------------------- | ----- |
| `license.url`         | Address of the License service. Ex.: {service-name}.svc                                         | `""`  |
