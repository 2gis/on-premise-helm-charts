...
| `types.web`    | If [web tiles](https://docs.2gis.com/en/on-premise/map#nav-lvl1@paramArchitecture) are enabled in Tiles API.                                                              | `true`                                                                   |
| `types.raster` | If [raster tiles](https://docs.2gis.com/en/on-premise/map#nav-lvl1@paramArchitecture) are enabled in Tiles API.                                                           | `true`                                                                   |
...
| `cassandra.keyspaces`               | **Custom user defined keyspaces. If some underlying parameters are set, the database cleaning and maintenance processes are skipped for the configured keyspaces.** |                |
| `cassandra.keyspaces.web`           | User defined keyspace for vector tiles data.                                                                                                                        | `""`           |
| `cassandra.keyspaces.raster`        | User defined keyspace for raster tiles data.                                                                                                                        | `""`           |
...
| `proxy.image.tag`                 | Docker image tag.                                                                                                             | `4.32.0`                          |
...
| `api.image.tag`                             | Docker image tag.                                                                                                                                                                                        | `4.32.0`                    |
...
| `importer.image.tag`                         | Docker image tag.                                                                                                                                                                                                                                                                                                                    | `4.32.0`                             |
