...
| `api.attractor_url`                      | URL of Navi-Back service.                                                                                                                                                                                  | `http://restrictions-api.host/attract/1.0.0/global/` |
...
| `api.service.targetPort`                 | External port.                                                                                                                                                                                             | `8000`                                               |
...
| `api.ingress.annotations`                | Kubernetes [annotations](https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations/). <br/> For example: `{"kubernetes.io/ingress.class": "nginx", "kubernetes.io/tls-acme": "true"}`. | `{}`                                                 |
| `api.ingress.hosts`                      | List of hosts. Must be a list, where each item has `host` property. <br/> Defaults to `[{"host": "restrictions-api.host", "paths": [{"path": "/", "pathType": "ImplementationSpecific"]}]`.                |                                                      |
| `api.ingress.tls`                        | TLS settings. <br/> For example: `[{'secretName': 'restrictions-api-tls', 'hosts': ['restrictions-api.host']}]`.                                                                                           | `[]`                                                 |
