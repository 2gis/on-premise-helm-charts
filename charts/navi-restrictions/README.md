...
This Helm chart deploys the **Restrictions API service**, a component of the 2GIS [On-Premise](https://docs.2gis.com/en/on-premise-api-platform/overview/summary#navigation).
...
* [Navigation API Documentation](https://docs.2gis.com/en/on-premise-api-platform/architecture/navigation#restrictions-api)
