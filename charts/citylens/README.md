...
| `worker.dashboardBatchEvents.image.tag`            | Tag.                                                                                                                                           | `1.18.0-rc`                        |
...
| `routes.api.image.tag`        | Tag.         | `1.1.1`                               |
...
| `routes.worker.image.tag`        | Tag.         | `1.1.1`                                   |
