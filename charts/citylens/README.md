...
This Helm chart deploys the **CityLens service**, a component of the 2GIS [On-Premise](https://docs.2gis.com/en/on-premise-citylens/overview/summary).
...
* [CityLens Documentation](https://docs.2gis.com/en/on-premise-citylens/overview/summary)
...
| `dgctlStorage.manifest`  | The path to the [manifest file](https://docs.2gis.com/en/on-premise-api-platform/installation#artifacts). Format: `manifests/citylens/0000000000.json` <br> This file contains the description of pieces of data that the service requires to operate. **Required** | `""`    |
...
### Realtime Data **Logging** settings
