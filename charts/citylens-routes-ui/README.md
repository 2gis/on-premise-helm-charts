# 2GIS CityLens Routes UI service

This Helm chart deploys the **CityLens Routes UI service**, a component of the 2GIS [On-Premise](https://docs.2gis.com/en/on-premise-citylens/overview/summary).
