...
| `kafka.sasl.createSecret`                 | Enable to manage password secret with helm                                                                                               | `true`                                                    |
| `kafka.sasl.secretName`                   | Kubernetes secret that holds password data. Ignored when kafka.sasl.createSecret is true. Required when kafka.sasl.createSecret is false | `""`                                                      |
...
| `kafka.sasl.username`                     | Username for kafka connection. Required when kafka.sasl.createSecret is true                                                             | `""`                                                      |
| `kafka.sasl.password`                     | Password for kafka connection. Required when kafka.sasl.createSecret is true                                                             | `""`                                                      |
