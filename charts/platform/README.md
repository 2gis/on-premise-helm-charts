...
| `ui.publicPages`              | A list of pages available in the application for unauthancticated user, delimeted by commas. Subset of 'ui.pages'. When no values are specified, all of the pages will require authentication.                                                                                                       | `""`   |
