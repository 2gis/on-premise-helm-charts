...
| `naviback.dmSourcesLimit`                               | Maximum number of sources in the distance matrix. For synchronous get_dist_matrix calls, the recommended limit is 25 (25x25 matrix max).                                                                               | `1000`                                   |
| `naviback.dmTargetsLimit`                               | Maximum number of targets in the distance matrix. For synchronous get_dist_matrix calls, the recommended limit is 25 (25x25 matrix max).                                                                               | `1000`                                   |
...
| `naviback.rtr.filename`                                 | Filename of the real time restrictions                                                                                                                                                                                 |                                          |
