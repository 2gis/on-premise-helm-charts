...
This Helm chart deploys the **Navi-Back service**, a component of the 2GIS [On-Premise](https://docs.2gis.com/en/on-premise-api-platform/overview/summary#navigation).
...
| Name                                                    | Description                                                                                                                                                                                                                                                                  | Value                                       |
| ------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
| `naviback.ecaHost`                                      | DEPRECATED: Use naviback.ecaUrl. Domain name of the [Traffic Proxy service](https://docs.2gis.com/en/on-premise-api-platform/overview/summary#traffic-proxy). <br> This URL should be accessible from all the pods within your Kubernetes cluster                            |                                             |
| `naviback.ecaUrl`                                       | URL of the [Traffic Proxy service](https://docs.2gis.com/en/on-premise-api-platform/overview/summary#traffic-proxy). <br> This URL should be accessible from all the pods within your Kubernetes cluster                                                                     |                                             |
| `naviback.forecastHost`                                 | DEPRECATED: naviback.forecastUrl. Use URL of Traffic forecast service. See the [Traffic Proxy service](https://docs.2gis.com/en/on-premise-api-platform/overview/summary#traffic-proxy). <br> This URL should be accessible from all the pods within your Kubernetes cluster |                                             |
| `naviback.forecastUrl`                                  | URL of Traffic forecast service. See the [Traffic Proxy service](https://docs.2gis.com/en/on-premise-api-platform/overview/summary#traffic-proxy). <br> This URL should be accessible from all the pods within your Kubernetes cluster                                       |                                             |
| `naviback.forecastFilename`                             | Filename of the forecast                                                                                                                                                                                                                                                     |                                             |
| `naviback.longForecastUrl`                              | URL of Traffic long forecast service. See the [Traffic Proxy service](https://docs.2gis.com/en/on-premise-api-platform/overview/summary#traffic-proxy). <br> This URL should be accessible from all the pods within your Kubernetes cluster                                  |                                             |
...
| `naviback.sentry.environment`                           | Environment name                                                                                                                                                                                                                                                             | `""`                                        |
| `naviback.sentry.reportPath`                            | Local directory to dump                                                                                                                                                                                                                                                      | `/tmp/sentry`                               |
| `naviback.sentry.handler`                               | Handler file location                                                                                                                                                                                                                                                        | `/usr/sbin/2gis/navi-back/crashpad_handler` |
| `naviback.sentry.minSeverityLevel`                      | Minimal severity level to log in sentry                                                                                                                                                                                                                                      | `error`                                     |
| `naviback.sentry.logsBufferSize`                        | Size of buffer to send to sentry                                                                                                                                                                                                                                             | `100`                                       |
| `naviback.telemetry.enabled`                            | Send telemetry to Opentelemetry server                                                                                                                                                                                                                                       | `false`                                     |
| `naviback.telemetry.host`                               | Telemetry host                                                                                                                                                                                                                                                               | `telemetry.server`                          |
| `naviback.telemetry.port`                               | Telemetry port                                                                                                                                                                                                                                                               | `4318`                                      |
| `naviback.telemetry.maxQueueSize`                       | Max number of buffered spans                                                                                                                                                                                                                                                 | `2048`                                      |
| `naviback.telemetry.scheduleDelayMillis`                | Interval of export of the buffered spans, ms                                                                                                                                                                                                                                 | `500`                                       |
| `naviback.telemetry.maxExportBatchSize`                 | Max number of spans sent to the exporter in a single export call                                                                                                                                                                                                             | `512`                                       |
...
| `rules`                                                 | List of routing rules configured on this instance, refer to full [documentation](https://docs.2gis.com/en/on-premise-api-platform/installation#rules-file) for details                                                                                                       | `[]`                                        |
...
| `stateTransmitter.kafka.fileProperties` | Properties stored in file, see `kafka` section and comments             | `{}`    |
