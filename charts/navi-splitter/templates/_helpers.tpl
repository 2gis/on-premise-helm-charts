...
helm.sh/chart: {{ include "splitter.chart" . }}
{{ include "splitter.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "splitter.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "splitter.fullname" .) .Values.serviceAccount.name }}
{{- else }}
