...
| `ingress.hosts`       | List of hosts. Must be a list, where each item has `host` property. <br/> Defaults to `[{"host": "navi-front.host", "paths": [{"path": "/", "pathType": "ImplementationSpecific"]}]`.                      |         |
| `ingress.tls`         | TLS settings. <br/> For example: `[{'secretName': 'navi-front-tls', 'hosts': ['navi-front.host']}]`.                                                                                                       | `[]`    |
...
| Name                 | Description                                          | Value   |
| -------------------- | ---------------------------------------------------- | ------- |
| `pdb.create`         | If PDB is enabled for the service.                   | `false` |
