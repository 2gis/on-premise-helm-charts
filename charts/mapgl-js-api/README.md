...
| `env.MAPGL_STYLESERVER`         | URL of the Styles API service.                                | `https://styles.api.2gis.com`                                                                     |
| `env.MAPGL_ICONSPATH`           | URL of the icons directory.                                   | `https://disk.2gis.com/styles/assets/icons`                                                       |
| `env.MAPGL_MODELSPATH`          | URL of the models directory.                                  | `https://disk.2gis.com/styles/assets/models`                                                      |
