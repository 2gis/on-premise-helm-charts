...
| `env.MAPGL_ICONS_URL`           | URL of the icons directory, e.g. 'https://styles.ingress.host/styles/assets/icons'. This URL must be public available (accessible from browser).   | `""`                                                                                              |
| `env.MAPGL_MODELS_URL`          | URL of the models directory, e.g. 'https://styles.ingress.host/styles/assets/models'. This URL must be public available (accessible from browser). | `""`                                                                                              |
