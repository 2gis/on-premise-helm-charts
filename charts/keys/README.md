...
| `counter.parallelismFactor`           | Default value for calculating the number of workers. If set to 0, the default value will be equal to the number of CPU cores.                                                                       | `0`       |
