...
| `postgres.ro.tls.mode`       | PostgreSQL ssl [connection mode](https://www.postgresql.org/docs/current/libpq-ssl.html#LIBPQ-SSL-PROTECTION). Available modes: `disabled`, `require`, `verify-ca` and `verify-full`. | `require` |
...
| `postgres.rw.tls.mode`       | PostgreSQL ssl [connection mode](https://www.postgresql.org/docs/current/libpq-ssl.html#LIBPQ-SSL-PROTECTION). Available modes: `disabled`, `require`, `verify-ca` and `verify-full`. | `require` |
