...
| `backend.image.tag`        | Backend service image tag.        | `1.140.0`                      |
...
| `api.oidc.issuerUrl`                        | Issuer URL allows discovery to work when the issuer_url reported by upstream is mismatched with the discovery URL.                                                                                                         | `""`            |
