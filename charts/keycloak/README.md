...
| `resources.requests.memory`             | A memory request.                                                                                                                                                      | `2Gi`           |
| `resources.limits.cpu`                  | A CPU limit.                                                                                                                                                           | `4`             |
| `resources.limits.memory`               | A memory limit.                                                                                                                                                        | `4Gi`           |
...
| `keycloakConfigCli.resources.requests.memory`             | A memory request.                                                                                                                         | `256Mi`                               |
| `keycloakConfigCli.resources.limits.cpu`                  | A CPU limit.                                                                                                                              | `1`                                   |
| `keycloakConfigCli.resources.limits.memory`               | A memory limit.                                                                                                                           | `512Mi`                               |
