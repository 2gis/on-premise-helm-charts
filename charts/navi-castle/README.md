...
| `dgctlStorage.secure`    | S3 secure. Format: `True/False`. If secure is not specified, try to parse directive `dgctlStorage.host`. If `dgctlStorage.host` containe "https" set `secure: True`                                                                                      | `""`  |
| `dgctlStorage.region`    | S3 region for AWS. Format: `String`.                                                                                                                                                                                                                     | `""`  |
