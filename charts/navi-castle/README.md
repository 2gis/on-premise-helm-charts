...
| `castle.image.tag`                     | Navi-Castle service image tag.                                                                                                                                                                                                                 | `1.12.1`                                                                                                        |
...
| `castle.onpremise`                     | Settings for On-Premise compatibility mode.                                                                                                                                                                                                    |                                                                                                                 |
| `castle.onpremise.enabled`             | Add `backup_dir` and routing metadata required by On-Premise Castle backup listings.                                                                                                                                                           | `true`                                                                                                          |
| `castle.onpremise.routing`             | Routing types included in `import` and `restrictionImport` backup metadata when On-Premise compatibility mode is enabled.                                                                                                                      | `["ctx","driving","bicycle","scooter","truck","pedestrian","taxi","motorcycle","emergency","public_transport"]` |
...
| `nginx.image.tag`                 | Navi-Front image tag.                                                                       | `1.31.1`                     |
