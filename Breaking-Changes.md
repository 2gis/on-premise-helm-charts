...
## [1.7.1]
#### gis-platform
- Rename `external_hostname` to `externalHostname`
- Rename `external_proto` to `externalProto`
- Rename `spcore.debug_mode` to `spcore.debugMode`
...
- Rename `portal.gzip_enabled` to `portal.gzipEnabled`
